...
/**
 * The color of selected event dots.
 */
@property (strong, nonatomic) UIColor  *selectedEventColor;
...
/**
 * The border color of calendar.
 */
@property (strong, nonatomic) UIColor  *calendarBorderColor;
